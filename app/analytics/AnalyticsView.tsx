...
export function AnalyticsView({ result: r, filters: f }: { result: AnalyticsViewData; filters: Filters }) {
  ...
  return <div className="analytics-page">
    ...
    {f.view === 'sales' ? <>
      ...
      <section className="card"><SectionHeading title="Sales trend" description="Daily source quantities grouped for readability. Gaps mean unavailable data, not zero sales." />
