...
- The narrative separates wholesale and retail wins and risks, reports each event once, and summarizes documented outcomes rather than prescribing actions. Retail evidence adds up to nine agency sales leaders/movers across all configured items. Agency week-over-week comparisons require complete imports for both weeks; negative net sales are not interpreted as demand declines. These are sales signals, not stockout predictions or explanations of why sales changed.
